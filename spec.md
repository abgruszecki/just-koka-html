...
- Tokenizer: passes the currently allowlisted tokenizer subset (5442/6810 = 79.9%) (includes non-`Data` `initialStates` and `lastStartTag` cases; parse errors still not emitted).
