...
- Tree-frag allowlist is now `82/192` (notably `foreign-fragment.dat` `49/66`, `tests4.dat` `8/9`, `tests6.dat` `4/13`, `tests_innerHTML_1.dat` `18/81`, and `template.dat` `1/1`).
